...
\SVN $Date: 2017-10-06 00:36:23 +0200 $
% 
...
\item[Web-Interface]
Vanaf je teampagina op \url{\BASEURL team} kun je bestand(en)
...
Vanaf je teampagina \url{\BASEURL team} kun je oplossingen insturen
door een of meer bestanden te selecteren met de \textbf{browse} knop in de
